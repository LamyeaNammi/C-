...
namespace Coders_Space
{
    public partial class ModifyJob : Form
    {
        ...
        private void updateJobBtn_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE USERS SET ID=@ID, COMPANYLOGO=@COMPANYLOGO, JOBTITLE=@JOBTITLE, COMPANYNAME=@COMPANYNAME, ADDRESS=@ADDRESS, SALARY=@SALARY, APPLYDEADLINE=@APPLYDEADLINE, USERTYPE=@USERTYPE, A_LINK=@A_LINK, UPDATE_DATE=@UPDATE_DATE";
